      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-800">CUIDAMEDIC</span>
          </div>
          ...
          {/* CTA Button */}
          <Button className="bg-yellow-500 hover:bg-yellow-600 text-white rounded-full px-6 py-2 flex items-center space-x-2">
