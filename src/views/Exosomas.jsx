...
export function Exosomas() {
  const API_ENZIMAS = '/api/exosoma?populate[Interna][populate][ImagenBanner]=true&populate[Interna][populate][Tabs]=true&populate[Interna][populate][Imagen]=true&populate[Interna][populate][Seo]=true&populate[Interna][populate][preguntas]=true';
