...
export default function EsteticosCorporalesPage() {
  // Obtener datos de la API de Strapi
  const API_ESTETICA = '/api/esteticas-corporal?populate[Servicios][populate]=*&populate[Banner]=true&populate[Seo]=true';
